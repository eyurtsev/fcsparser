...
file_formats = {
                'mq fcs 2.0' : os.path.join(_ROOT, 'MiltenyiBiotec', 'FCS2.0', 'EY_2013-07-19_PBS_FCS_2.0_Custom_Without_Add_Well_A1.001.fcs'),
                'mq fcs 3.0' : os.path.join(_ROOT, 'MiltenyiBiotec', 'FCS3.0', 'FCS3.0_Custom_Compatible.fcs'),
...
additional_files = {
        'duplicate_names': os.path.join(_ROOT, 'MiltenyiBiotec', 'FCS3.1', 'SG_2014-09-26_Duplicate_Names.fcs'),
        'corrupted_file' : os.path.join(_ROOT, 'corrupted', 'corrupted.fcs'),
        'test_channel_naming': os.path.join(_ROOT, 'MiltenyiBiotec', 'FCS3.1', 'EY_2013-07-19_PBS_FCS_3.1_Well_A1.001.fcs')
        }
...
class TestFCSReader(unittest.TestCase):
    ...
    def test_reading_corrupted_fcs_file(self):
        ...
        path = additional_files['corrupted_file']
    ...
    def test_reading_in_memory_fcs_file(self):
        """ Properly finding data segment of an in-memory FCS file """
        values = array([[4.99655876159667968750e+01, -1.78884857177734375000e+02,
                         3.53545867919921875000e+02, -6.63189687500000000000e+04,
                         1.53373974609375000000e+03, 1.71934411621093750000e+03,
                         1.16922687500000000000e+05, -1.85308218002319335938e+00,
